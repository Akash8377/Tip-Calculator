const bill_input = document.getElementById("bill-field");
const custom_tip_input = document.getElementById("tip-custom");
const people_input = document.getElementById("select-people");
